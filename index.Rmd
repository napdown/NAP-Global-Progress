...
plot_ly(ldc,type='bar',x=~countryname,y=~Total, color = ~Category2, colors = 'Blue', showlegend=F)%>%
  plotly::layout(barmode='stack', xaxis = list(title = ""),yaxis=list(range=c(0,450), title='Total Amount ((Million USD)'))
```
...
plot_ly(otherdc,type='bar',x=~countryname,y=~Total, color = ~Category2, colors = 'Blue', showlegend=F)%>%
  plotly::layout(barmode='stack', xaxis = list(title = ""),yaxis=list(title='Total Amount ((Million USD)'))
```
