...
mdf$Measure1<-factor(mdf$Measure1, levels = unique(mdf$Measure1)[order(mdf$Code, decreasing = F)])

mdf$Element<-factor(mdf$Element)

#levels(mdf$Element)<-c("A. Laying the groundwork and addressing gaps","B. Preparatory elements","C. Implementation strategies","D. Reporting, monitoring and review")

plotA<-mdf%>%filter(Element=="A. Laying the groundwork and addressing gaps")%>%plot_ly(type='bar',y=~value,x=~Measure1wrap, color = ~variable, colors = c('#512679', '#8567a1','#b9a8c9'),text=~value, textposition= 'middle',textfont=list(size=12, color='white'), showlegend=F)%>%
...
plotB<-mdf%>%filter(Element=="B. Preparatory elements")%>%plot_ly(type='bar',y=~value,x=~Measure1wrap,text=~value, textposition= 'bottom middle',textfont=list(size=12, color='white'), color = ~variable, colors = c('#512679', '#8567a1','#b9a8c9'), showlegend=F)%>%
  plotly::layout(barmode='stack', xaxis = list(title = "B. Preparatory elements"),yaxis=list(title='No. of Countries'))

plotC<- mdf%>%filter(Element=="C. Implementation strategies")%>%plot_ly(type='bar',y=~value,x=~Measure1wrap,text=~value, textposition= 'middle',textfont=list(size=12, color='white'), color = ~variable, colors = c('#512679', '#8567a1','#b9a8c9'), showlegend=F)%>%
  plotly::layout(barmode='stack', xaxis = list(title = "C. Implementation strategies"),yaxis=list(title='No. of Countries'))

plotD<-mdf%>%filter(Element=="D. Reporting, monitoring and review")%>% plot_ly(type='bar',y=~value,x=~Measure1wrap, text=~value, textposition= 'middle',textfont=list(size=12, color='white'), color = ~variable, colors = c('#512679', '#8567a1','#b9a8c9'), showlegend=T)%>%
...
df$Measurewrap<-sapply(df$Measure, FUN = function(Measure){paste(strwrap(Measure, width = 40), collapse = "<br>")})
df$Measurewrap<-factor(df$Measurewrap, levels = unique(df$Measurewrap)[order(df$`Measure code`,decreasing = F)])

plot_ly(df,type='bar',x=~Measurewrap, y=~Countries, text=~Countries, textposition='auto', color = ~Measure, colors = 'Reds',legendgroup=~Measure, showlegend=F)%>%
...
af_plot<-plot_ly(africa,type='bar',x=~Measurewrap,y=~Countries, color = ~Measure, colors = 'Reds',legendgroup=~Measure, showlegend=F)%>%
...
asia_plot<-plot_ly(asia_pacific, type='bar',x=~Measurewrap,y=~Countries, color = ~Measure, colors = 'Reds',legendgroup=~Measure, showlegend=F)%>%
...
lac_plot<-plot_ly(lac,type='bar',x=~Measurewrap,y=~Countries, color = ~Measure, colors = 'Reds',legendgroup=~Measure, showlegend=F)%>%
...
eu_plot<-plot_ly(eu,type='bar',x=~Measurewrap,y=~Countries, color = ~Measure, colors = 'Reds',legendgroup=~Measure, showlegend=F)%>%
...
ldc_plot<-plot_ly(ldc,type='bar',x=~Measurewrap,y=~Countries, color = ~Measure, colors = 'Reds', showlegend=F)%>%
...
otherdc_plot<-plot_ly(otherdc,type='bar',x=~Measurewrap,y=~Countries, color = ~Measure, colors = 'Reds', showlegend=F, name='Other DC')%>%
