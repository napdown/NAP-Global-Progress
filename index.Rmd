...
approvals<-read_excel("Open_NAPs_Database.xlsm", sheet = "Readiness_Approval")%>%na.omit()
...
plot_ly(df,type='bar',x=~Measurewrap, y=~Countries, text=~Countries, textposition='auto', color = ~Measure, colors = 'Blues',legendgroup=~Measure, showlegend=F)%>%
