...
### Total GCF Projects by Country {data-commentary-width=400}
```{r}
...
shared_df%>%
  ...
  #setMaxBounds(-90,-60,90,60)%>%
  addCircleMarkers(fill = T, weight = ~`Readiness support approved`*0.1,radius =~`Readiness support approved`*2, color = '#fc7204',
