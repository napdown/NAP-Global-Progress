...
p<-ggplot(country_tot)+
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size = 11), axis.text.y = element_text(size = 11), axis.title.y = element_text(size = 11), axis.title.x = element_blank())
ggplotly(p)
...
plot_ly(ldc,type='bar',x=~countryname,y=~Total, color = ~Category2, colors = 'Blue', showlegend=F)%>%
  plotly::layout(barmode='stack', xaxis = list(title = "", tickangle=90, tickfont=list(size=16)),yaxis=list(range=c(0,450), tickfont=list(size=16), title='Total Amount ((Million USD)', titlefont=list(size=20)))
```
...
plot_ly(otherdc,type='bar',x=~countryname,y=~Total, color = ~Category2, colors = 'Blue', showlegend=F)%>%
 plotly::layout(barmode='stack', xaxis = list(title = "", tickangle=90, tickfont=list(size=15.85)),yaxis=list(range=c(0,450), tickfont=list(size=16), title='Total Amount ((Million USD)', titlefont=list(size=16)))
```
